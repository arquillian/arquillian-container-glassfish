...
import org.jboss.arquillian.container.glassfish.embedded_3_1.GlassFishConfigProcessor;
import org.jboss.arquillian.container.glassfish.embedded_3_1.GlassFishConfiguration;
import org.junit.Test;

public class GlassfishProcessorTest
{
	...
	public void testValidInstallRoot() throws Exception
	{
		...
		GlassFishConfigProcessor.processConfig(config);
	}
	...
	public void testValidConfigXmlPath() throws Exception
	{
		...
		GlassFishConfiguration processedConfig = GlassFishConfigProcessor.processConfig(config);
		assertTrue(processedConfig.getConfigurationXml().startsWith("file:"));
	}
